...
function getColor(p) {
		return p > .5 ? '#2670b9' :  //greater than 50%
				   p > .4  ? '#55c6f0' : //greater than 40%
				   p > .3  ? '#acdee9' : //greater than 30%
				   p > .2  ? '#fff8ff' : //greater than 20%
...
function createMap(){
    ...
    //create the map
    map = L.map('mapid', {
        center: [42.262120,-71.802240],
        zoom: 12
    });

    //add  base tilelayer
		var myBasemap =  L.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/terrain/{z}/{x}/{y}{r}.{ext}', {
